...
public class QueryEmpConfigsE2ETest extends BaseE2EServiceTest {
    ...
    public void testQueryEmpConfigs() throws Exception {
        ...
        response = given().headers("Content-Type", "text/xml").headers("Content-Type", "text/xml")
                .body(readFileContent(getFileName("QueryEmpConfigs"))).post(DM_SERVICE_SOAP_ENDPOINT_1000).body();
        ...
        XmlPath xmlPath = new XmlPath(response.asString()).setRoot("Envelope.Body.queryEmpConfigsResponse.return");
