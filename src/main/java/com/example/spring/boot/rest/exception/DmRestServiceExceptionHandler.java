...
/**
 * This is the main exception handler for the Dm REST services. Add the
...
public class DmRestServiceExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleHttpMediaTypeNotSupported(HttpMediaTypeNotSupportedException ex,
        ...
        if (request instanceof ServletWebRequest) {
            ...
            LOG.warn("Unknown request object type. Please update code to handle this: {}", request.getClass().getName());
