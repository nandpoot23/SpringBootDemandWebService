...
class QueryEmpConfigsTest extends Simulation{
...
val testParams = new TestParams()
    ...
    val scn = scenario("DmService-QueryEmpConfigs")
    .exec(http("QueryEmpConfigs")
    .post("/DmService/1.0")
    .body(RawFileBody("src/performanceTest/resources/QueryEmpConfigPerformanceRequest.xml"))
